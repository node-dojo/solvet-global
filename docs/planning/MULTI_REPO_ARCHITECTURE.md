...
### Repository 3: SOLVET Asset Management Add-on Repository
**Purpose:** Internal Blender add-on that generates and exports assets (part of SOLVET workflow)  
**Location:** `solvet-asset-management-addon/`  
**Remote:** `github.com/[org]/solvet-asset-management-addon`  
**Tech Stack:** Python, Blender API  
**Note:** This is the internal export tool, separate from the customer-facing NO3D Tools Asset Library add-on

### Repository 4: NO3D Tools Asset Library Add-on Repository
**Purpose:** Customer-facing Blender add-on for importing/consuming assets (product offering)  
**Location:** `no3d-tools-addon/`  
