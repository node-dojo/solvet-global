...
3. ✅ **solvet-asset-management-addon** - Internal export add-on repository
4. ✅ **no3d-tools-addon** - Customer asset library add-on repository
...
#### 3. Create solvet-asset-management-addon Repository (Internal Export Add-on)

1. Go to [github.com/new](https://github.com/new)
2. Fill in the details:
   - **Repository name**: `solvet-asset-management-addon`
   - **Description**: `SOLVET Asset Management Add-on - Internal Blender add-on for exporting assets (part of SOLVET workflow)`
   - **Visibility**: Private (internal use) or Public
   - **Initialize**: ❌ **DO NOT** check any boxes
3. Click "Create repository"
4. **Keep the page open**

#### 4. Create no3d-tools-addon Repository (Customer Asset Library Add-on)

1. Go to [github.com/new](https://github.com/new)
2. Fill in the details:
   - **Repository name**: `no3d-tools-addon`
   - **Description**: `NO3D Tools Asset Library - Customer-facing Blender add-on for importing/consuming assets (product offering)`
   - **Visibility**: Public (recommended)
   - **Initialize**: ❌ **DO NOT** check any boxes
3. Click "Create repository"
4. **Keep the page open**

**Note:** These are two separate add-ons:
- **SOLVET Asset Management Add-on** (internal) - exports assets TO the library
...
gh repo create solvet-asset-management-addon --public --description "SOLVET Asset Management Add-on - Internal export tool"
gh repo create no3d-tools-addon --public --description "NO3D Tools Asset Library - Customer-facing asset library add-on"
```
...
### Connect solvet-asset-management-addon (Internal Export Add-on)

```bash
cd solvet-asset-management-addon

# Add GitHub remote
git remote add origin https://github.com/YOUR-USERNAME/solvet-asset-management-addon.git
```

### Connect no3d-tools-addon (Customer Asset Library Add-on)
...
https://github.com/YOUR-USERNAME/solvet-asset-management-addon
